  ...
  useEffect(() => {
    if (isOpen) {
      ...
      gsap.fromTo(contentRef.current,
        ...
        { opacity: 1, scale: 1, y: 0, duration: 0.4, ease: 'power2.out', delay: 0.05 }
      );
      ...
      <div ref={contentRef} className={styles.content}>
        ...
        <div className={styles.projectBody}>
          ...
          <div className={styles.actions}>
            ...
            {project.githubUrl && (
              <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className={styles.githubButton}>
